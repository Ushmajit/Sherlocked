...
public class question7 extends ActionBarActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn=(Button)findViewById(R.id.next7);
        a=(CheckBox)findViewById(R.id.seven3);
        b=(CheckBox)findViewById(R.id.seven1);
        c=(CheckBox)findViewById(R.id.seven2);
        d=(CheckBox)findViewById(R.id.seven4);
        c.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (v.getId() == R.id.seven2)
                    score += 10;
                c.setChecked(true);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent q5 = new Intent(question7.this, question8.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id)
        {
            ...
            case R.id.loadgame:
                ...
                break;
            case R.id.newgame:
                Intent in=new Intent(question7.this,Home.class);
