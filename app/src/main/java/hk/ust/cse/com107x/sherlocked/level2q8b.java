...
public class level2q8b extends ActionBarActivity {
    int score1,score; ImageButton i;
    String answer8 = "John Jacobson";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_level2q8b);
        score1 = getIntent().getExtras().getInt("score1");

        i=(ImageButton)findViewById(R.id.level2q8b);
        i.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText a8 = (EditText) findViewById(R.id.ans8);
                String ans8 = a8.getText().toString();
                if(ans8.equalsIgnoreCase(answer8)) {
                    score1 = score1 + 10;

                }
                Intent n = new Intent(level2q8b.this, level2q9a.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_level2q8b, menu);
        return true;
    }
