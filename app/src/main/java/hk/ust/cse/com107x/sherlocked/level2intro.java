...
public class level2intro extends ActionBarActivity {
   ...
   int score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level2intro);
      score=getIntent().getExtras().getInt("score");
        b1=(ImageButton)findViewById(R.id.level2intro);
        b1.setOnClickListener(new View.OnClickListener(){
            @Override
           public void onClick(View v)
            {
                if(v.getId()==R.id.level2intro)
                {
                    Intent a=new Intent(level2intro.this,level2q1.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_level2intro, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
...

        {
            ...
            case R.id.loadgame:
                ...
                break;
            case R.id.newgame:
                Intent in=new Intent(level2intro.this,Home.class);
