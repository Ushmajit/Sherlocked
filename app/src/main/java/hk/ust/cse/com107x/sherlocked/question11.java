...
public class question11 extends ActionBarActivity{
     int score;
    Button btn;
    CheckBox a,b,c,d;    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_question11);
        score=getIntent().getExtras().getInt("score");
        btn=(Button)findViewById(R.id.next11);
        a=(CheckBox)findViewById(R.id.eleven1);
        b=(CheckBox)findViewById(R.id.eleven2);
        c=(CheckBox)findViewById(R.id.eleven4);
        d=(CheckBox)findViewById(R.id.eleven3);
        c.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (v.getId() == R.id.eleven4)
                    score += 10;
                c.setChecked(true);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent q5 = new Intent(question11.this,question12.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id)
        {
            ...
            case R.id.loadgame:
                ...
                break;
            case R.id.newgame:
                Intent in=new Intent(question11.this,Home.class);
