...
public class question13 extends ActionBarActivity  {
 int score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn=(Button)findViewById(R.id.next13);
        score=getIntent().getExtras().getInt("score");
        a=(CheckBox)findViewById(R.id.tha);
        b=(CheckBox)findViewById(R.id.thc);
        c=(CheckBox)findViewById(R.id.thb);
        d=(CheckBox)findViewById(R.id.thd);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent q5 = new Intent(question13.this, question14.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id)
        {
            ...
            case R.id.loadgame:
                ...
                break;
            case R.id.newgame:
                Intent in=new Intent(question13.this,Home.class);
