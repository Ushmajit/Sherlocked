...
public class level2q3b extends ActionBarActivity {
    int score1,score;ImageButton i;
    String answer3="wife";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_level2q3b);
        score1=getIntent().getExtras().getInt("score1");

        i=(ImageButton)findViewById(R.id.level2q3b);
        i.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText a2=(EditText)findViewById(R.id.ans3);
                String ans3=a2.getText().toString();

                if(ans3.equalsIgnoreCase(answer3))
                {
                    score1=score1+10;
                }
                Intent n=new Intent(level2q3b.this,level2q4a.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_level2q3b, menu);
        return true;
    }
