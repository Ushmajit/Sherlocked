...
public class level2q4b extends ActionBarActivity {
    int score1,score;
    ImageButton i;
    String answer4="Jeff killed mike";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_level2q4b);

        score1=getIntent().getExtras().getInt("score1");

        i=(ImageButton)findViewById(R.id.level2q4b);
        i.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText a4=(EditText)findViewById(R.id.ans4);
                ...
                Intent n = new Intent(level2q4b.this, level2q5a.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_level2q4b, menu);
        return true;
    }
