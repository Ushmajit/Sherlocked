...
public class question8 extends ActionBarActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn=(Button)findViewById(R.id.next8);
        a=(CheckBox)findViewById(R.id.eight2);
        b=(CheckBox)findViewById(R.id.eight1);
        c=(CheckBox)findViewById(R.id.eight4);
        d=(CheckBox)findViewById(R.id.eight3);
        c.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (v.getId() == R.id.eight4)
                    score += 10;
                c.setChecked(true);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent q5 = new Intent(question8.this, question9.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id)
        {
            ...
            case R.id.loadgame:
                ...
                break;
            case R.id.newgame:
                Intent in=new Intent(question8.this,Home.class);
