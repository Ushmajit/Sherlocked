...
public class level2q6b extends ActionBarActivity {
    int score1,score; ImageButton i;
    String answer6="mother";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_level2q6b);
        score1=getIntent().getExtras().getInt("score1");
        EditText a6=(EditText)findViewById(R.id.ans6);
        final String ans6=a6.getText().toString();
        i=(ImageButton)findViewById(R.id.level2q6b);
        i.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText a6=(EditText)findViewById(R.id.ans6);
                String ans6=a6.getText().toString();
                if(ans6.equalsIgnoreCase(answer6)) {
                    score1 = score1 + 10;

                }
                Intent n = new Intent(level2q6b.this, level2q7a.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_level2q6b, menu);
        return true;
    }
