...
public class level2q5b extends ActionBarActivity {
    int score1,score;
    ImageButton i;
    String answer5="Aman";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level2q5b);
        score1=getIntent().getExtras().getInt("score1");

        i=(ImageButton)findViewById(R.id.l2q5b);
        i.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText a5=(EditText)findViewById(R.id.ans5);
                 String ans5=a5.getText().toString();
                if(ans5.equalsIgnoreCase(answer5)) {
                    score1 = score1 + 10;

                }
                Intent n = new Intent(getApplicationContext(), level2q6a.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_level2q5b, menu);
        return true;
    }
