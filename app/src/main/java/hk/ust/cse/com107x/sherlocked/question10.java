...
public class question10 extends ActionBarActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn=(Button)findViewById(R.id.next10);
        a=(CheckBox)findViewById(R.id.ten2);
        b=(CheckBox)findViewById(R.id.ten1);
        c=(CheckBox)findViewById(R.id.ten3);
        d=(CheckBox)findViewById(R.id.ten4);
        c.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (v.getId() == R.id.ten3)
                    score += 10;
                c.setChecked(true);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent q5 = new Intent(question10.this, question11.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id)
        {
            ...
            case R.id.loadgame:
                ...
                break;
            case R.id.newgame:
                Intent in=new Intent(question10.this,Home.class);
