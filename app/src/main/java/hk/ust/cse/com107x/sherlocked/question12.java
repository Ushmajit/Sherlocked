...
public class question12 extends ActionBarActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       score=getIntent().getExtras().getInt("score");
        btn=(Button)findViewById(R.id.next12);
        a=(CheckBox)findViewById(R.id.twelve3);
        b=(CheckBox)findViewById(R.id.twelve2);
        c=(CheckBox)findViewById(R.id.twelve1);
        d=(CheckBox)findViewById(R.id.twelve4);
        c.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (v.getId() == R.id.twelve1)
                    score += 10;
                c.setChecked(true);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent q5 = new Intent(question12.this, question13.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id)
        {
            ...
            case R.id.loadgame:
                ...
                break;
            case R.id.newgame:
                Intent in=new Intent(question12.this,Home.class);
