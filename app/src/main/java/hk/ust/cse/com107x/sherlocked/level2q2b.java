...
public class level2q2b extends ActionBarActivity {
int score1,score;
    ImageButton i;
    String answer2="maid";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level2q2b);
        score1=getIntent().getExtras().getInt("score1");

        i=(ImageButton)findViewById(R.id.level2q2b);
        i.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText a1=(EditText)findViewById(R.id.ans2);
                 String ans2= a1.getText().toString();
                if(ans2.equalsIgnoreCase(answer2))
                {
                    score1=score1+10;
                }
                Intent n=new Intent(level2q2b.this,level2q3a.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_level2q2b, menu);
        return true;
    }
