...
public class question4 extends ActionBarActivity
{
 ...
 Button btn;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        f=(CheckBox)findViewById(R.id.four6);
        a=(CheckBox)findViewById(R.id.four1);
        b=(CheckBox)findViewById(R.id.four2);
        c=(CheckBox)findViewById(R.id.four3);
        d=(CheckBox)findViewById(R.id.four4);
        e=(CheckBox)findViewById(R.id.four5);
        f.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (v.getId() == R.id.four6)
                    score += 10;
                    f.setChecked(true);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent q4 = new Intent(question4.this, question5.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id)
        {
            ...
            case R.id.loadgame:
                ...
                break;
            case R.id.newgame:
                Intent in=new Intent(question4.this,Home.class);
                ...
                Toast.makeText(getApplicationContext(),"Cam't Load Game Right Now",Toast.LENGTH_SHORT).show();
                break;
            default:
                break;
        }
