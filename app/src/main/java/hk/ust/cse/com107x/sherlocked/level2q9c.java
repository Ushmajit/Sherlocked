...
public class level2q9c extends ActionBarActivity {
    int score1,score; ImageButton i;
    String answer9="Jimmy";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_level2q9c);
        score1=getIntent().getExtras().getInt("score1");

        i=(ImageButton)findViewById(R.id.level2q9c);
        i.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText a9=(EditText)findViewById(R.id.ans9);
                 String ans9=a9.getText().toString();

                if(ans9.equalsIgnoreCase(answer9)) {
                    score1 = score1 + 10;

                }
                Intent n = new Intent(level2q9c.this, level2q10a.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_level2q9c, menu);
        return true;
    }
