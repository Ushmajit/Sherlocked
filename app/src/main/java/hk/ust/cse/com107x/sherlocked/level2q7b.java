...
public class level2q7b extends ActionBarActivity {
    int score1,score; ImageButton i;
    String answer7 = "Terry";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_level2q7b);
        score1 = getIntent().getExtras().getInt("score1");

        i=(ImageButton)findViewById(R.id.level2q7b);
        i.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText a7 = (EditText) findViewById(R.id.ans7);
                String ans7 = a7.getText().toString();
                if(ans7.equalsIgnoreCase(answer7)) {
                    score1 = score1 + 10;

                }
                Intent n = new Intent(level2q7b.this, level2q8a.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_level2q7b, menu);
        return true;
    }
