...
int score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a=(CheckBox)findViewById(R.id.five3);
        b=(CheckBox)findViewById(R.id.five1);
        c=(CheckBox)findViewById(R.id.five2);
        d=(CheckBox)findViewById(R.id.five4);
        c.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (v.getId() == R.id.five2)
                    score += 10;
                c.setChecked(true);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent q5 = new Intent(question5.this, question6.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id)
        {
            ...
            case R.id.loadgame:
                ...
                break;
            case R.id.newgame:
                Intent in=new Intent(question5.this,Home.class);
